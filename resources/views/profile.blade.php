                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3 mb-md-0">
                            <div class="text-center">
                                ...
                                <p class="text-muted">Information Systems Students '22</p>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item">Live: <br><i class="bi bi-geo-alt"></i> Surabaya</li>
                                        <li class="list-group-item">College: <br><i class="bi bi-building"></i> University Telkom Surabaya</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
